...
function JsonSerializerPlugin() {
    return {
        ...
        deserializeModel: function (props) {
            ...
            var rootTopicKey = obj.rootTopicKey, topics = obj.topics, config = obj.config;
            var model = new Model();
            model = model.merge({
                rootTopicKey: rootTopicKey,
                editorRootTopicKey: rootTopicKey,
                config: controller.run('deserializeConfig', __assign(__assign({}, props), { obj: config })),
                topics: controller.run('deserializeTopics', __assign(__assign({}, props), { obj: topics }))
            });
