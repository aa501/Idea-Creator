...
var RichTextEditor = /** @class */ (function (_super) {
    ...
    RichTextEditor.prototype.render = function () {
        ...
        return (React.createElement(NodeContent, { key: key, readOnly: readOnly, ref: saveRef(key), onMouseDown: this.onMouseDown, onMouseMove: this.onMouseMove },
            React.createElement(RichMarkDownEditor, { editorValue: content, readOnly: readOnly, onChange: this.onChange })));
    };
...
var TopicContentEditor = /** @class */ (function (_super) {
    ...
    function TopicContentEditor() {
        ...
        _this.onChange = function (value) {
            _this.operation(rendererReact.OpType.SET_TOPIC_CONTENT, __assign(__assign({}, _this.props), { content: value }));
        };
        return _this;
    }
...
var TopicDescEditor = /** @class */ (function (_super) {
    ...
    function TopicDescEditor() {
        ...
        _this.onChange = function (value) {
            _this.operation(rendererReact.OpType.SET_TOPIC_DESC, __assign(__assign({}, _this.props), { desc: value }));
        };
        return _this;
    }
