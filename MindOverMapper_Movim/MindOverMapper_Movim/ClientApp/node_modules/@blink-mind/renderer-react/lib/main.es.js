import { PureComponent, Component, createElement, Fragment } from 'react';
...
function OperationPlugin() {
    ...
    var startEditingDesc = function (_a) {
        ...
        if (desc.block == null || desc.block.data == null) {
            model = ModelModifier.setDesc({ model: model, topicKey: topicKey, desc: '' });
        }
        return ModelModifier.focusTopic({
            model: model,
            topicKey: topicKey,
            ...
            createElement(PopRoot, null,
                ...
                createElement("div", null,
                    createElement(SettingItem, null,
                        createElement(PxSelect, { items: borderWidthItems, itemRenderer: renderItem('px'), filterable: false, onItemSelect: this.handleBorderWidthChange },
                            createElement(Button, { text: "width: " + (topicStyle.borderWidth ? topicStyle.borderWidth : '0px') }))),
                    createElement(SettingItem, null,
                        createElement(PxSelect, { items: borderStyleItems, itemRenderer: renderItem(''), filterable: false, onItemSelect: this.handleBorderStyleChange },
                            createElement(Button, { text: "style: " + (topicStyle.borderStyle ? topicStyle.borderStyle : 'none') }))),
                    createElement(SettingItem, null,
                        createElement(PxSelect, { items: borderRadiusItems, itemRenderer: renderItem('px'), filterable: false, onItemSelect: this.handleBorderRadiusChange },
                    ...
                    createElement(SettingItem, null,
                        createElement(Popover, null,
                            ...
                            createElement("div", null,
                                createElement(SketchPicker, { color: topicStyle.borderColor, onChangeComplete: this.handleBorderColorChange }))))),
                ...
                createElement("div", null,
                    createElement(SettingItem, null,
                        createElement(PxSelect, { items: borderWidthItems, itemRenderer: renderItem('px'), filterable: false, onItemSelect: this.handleLinkWidthChange },
                            createElement(Button, { text: "width: " + (linkStyle ? linkStyle.lineWidth : '0px') }))),
                    createElement(SettingItem, null,
                        createElement(Popover, null,
                            createElement(WithBorder, null,
                                createElement("div", { className: iconClassName(IconName.COLOR_PICKER) }),
                                createElement(ColorBar, { color: topicStyle.background })),
                            createElement("div", null,
                                createElement(SketchPicker, { color: topicStyle.background, onChangeComplete: this.handleLinkColorChange }))))))));
    };
    return StyleEditor;
}(BaseWidget));
...
var RootSubLinks = /** @class */ (function (_super) {
    ...
    RootSubLinks.prototype.layout = function () {
        ...
        topic.subKeys.forEach(function (key) {
            ...
            curves.push(createElement("path", { key: "link-" + key, d: curve, strokeWidth: style.linkStyle.lineWidth, stroke: style.linkStyle.lineColor, fill: "none" }));
        });
        this.setState({
            curves: curves
        });
...
function TopicDescIcon(props) {
    ...
    return (desc.block && (createElement(DescIcon, { onClick: onClick, className: iconClassName(IconName.NOTES) })));
}
...
var SimpleTextEditor = /** @class */ (function (_super) {
    ...
    SimpleTextEditor.prototype.render = function () {
        return (createElement(ContentEditable, { ref: this.domNodeRef, 
...
var SimpleTopicContentEditor = /** @class */ (function (_super) {
    ...
    SimpleTopicContentEditor.prototype.render = function () {
        ...
        return (createElement(NodeContent, { key: key, readOnly: readOnly, ref: saveRef(key), onMouseDown: this.onMouseDown, onMouseMove: this.onMouseMove },
            createElement(SimpleTextEditor, { editorValue: content, readOnly: readOnly, onChange: this.onChange })));
    };
...
var SimpleTopicDescEditor = /** @class */ (function (_super) {
    ...
    SimpleTopicDescEditor.prototype.render = function () {
        ...
        return (createElement(NodeContent$1, { key: key, readOnly: readOnly, ref: saveRef(key), onMouseDown: this.onMouseDown, onMouseMove: this.onMouseMove },
            createElement(SimpleTextEditor, { editorValue: content, readOnly: readOnly, onChange: this.onChange })));
    };
        ...
        renderDiagram: function (props) {
            ...
            return (createElement(SaveRef, null, function (saveRef, getRef) {
                ...
                return (createElement(Theme, { theme: model.config.theme },
                    createElement(DiagramRoot, null,
        ...
        renderModal: function (props) {
            ...
            if (activeModalProps) {
                if (activeModalProps.name === 'edit-desc') {
                    ...
                    return (createElement(ModalBody, null,
                        createElement(ModalDescEditor, null, controller.run('renderTopicDescEditor', modalProps))));
                }
            }
            return null;
        },
...
export { BaseWidget, Diagram, Icon, IconName, OpType, centerPointX, centerPointY, centerX, centerY, collapseRefKey, contentRefKey, getLinkKey, iconClassName, linksRefKey, linksSvgRefKey, topicRefKey };
